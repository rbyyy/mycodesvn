...
import com.law.fangyuan.modify.NewsFragment.getList;

public class NewShowNewsActivity  extends Fragment {//extends FragmentActivity
...
//		mColumnHorizontalScrollView.setBackgroundColor(Color.GREEN);
		mRadioGroup_content = (LinearLayout)v.findViewById(R.id.mRadioGroup_content);
//		mRadioGroup_content.setBackgroundColor(Color.GRAY);
