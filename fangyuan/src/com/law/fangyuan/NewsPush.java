...
public class NewsPush extends Activity {
	private int p = 1;
	private int com = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> av, View v, int position,
				...
				intent.putExtras(b);
				intent.setClass(NewsPush.this, NewsContent.class);
				NewsPush.this.startActivityForResult(intent, 10);
			}
		...
		((ImageView) findViewById(R.id.ivTitleBtnLeft)).setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				NewsPush.this.finish();
			}
			
		});
        AMenu.NewsBottomEven(NewsPush.this, 3);
        getData();
	}
	
	public void getData(){
		cache_name = "list/push_"+Integer.toString(p);
			...
			if(adapter==null){
		        ...
		        listView.post(new Runnable(){
					...
					public void run() {
						...
						((Loading)NewsPush.this.findViewById(R.id.loading)).setVisibility(View.GONE);
					}
	...
	class getList extends AsyncTask<Object, Object, Object>{
		...
		protected Object doInBackground(Object... arg0) {
			// TODO Auto-generated method stub
			String result="";
			Http http = new Http(NewsPush.this);
			result = http.GET("http://www.60886666.com/android/?m=getPushList&page="+Integer.toString(p));
			if(!result.equals("")){
