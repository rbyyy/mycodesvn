...
public class Announce extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> av, View v, int position,
				...
				intent.putExtras(b);
				intent.setClass(Announce.this, NewsContent.class);
				Announce.this.startActivityForResult(intent, 10);
			}
			...
			if(adapter==null){
		        ...
		        listView.post(new Runnable(){
					...
					public void run() {
						...
						((Loading)Announce.this.findViewById(R.id.loading)).setVisibility(View.GONE);
					}
	...
	class getList extends AsyncTask<Object, Object, Object>{
		...
		protected Object doInBackground(Object... arg0) {
			// TODO Auto-generated method stub
			String result="";
			Http http = new Http(Announce.this);
