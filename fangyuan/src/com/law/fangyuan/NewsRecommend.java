...
public class NewsRecommend extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> av, View v, int position,
				...
				intent.putExtras(b);
				intent.setClass(NewsRecommend.this, NewsContent.class);
				NewsRecommend.this.startActivityForResult(intent, 10);
			}
		...
		((ImageView) findViewById(R.id.ivTitleBtnLeft)).setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				NewsRecommend.this.finish();
			}
			
		});
        AMenu.NewsBottomEven(NewsRecommend.this, 2);
        getData();
	}
	
	public void getData(){
		cache_name = "list/recommend_"+"_"+Integer.toString(p);
			...
			if(adapter==null){
		        ...
		        listView.post(new Runnable(){
					...
					public void run() {
						...
						((Loading)NewsRecommend.this.findViewById(R.id.loading)).setVisibility(View.GONE);
					}
	...
	class getList extends AsyncTask<Object, Object, Object>{
		...
		protected Object doInBackground(Object... arg0) {
			// TODO Auto-generated method stub
			String result="";
			Http http = new Http(NewsRecommend.this);
			result = http.GET("http://www.60886666.com/android/?m=NewsRecommendList&page="+Integer.toString(p));
			if(!result.equals("")){
